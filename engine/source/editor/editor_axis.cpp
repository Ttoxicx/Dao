...
namespace Dao {
    ...
    EditorScaleAxis::EditorScaleAxis() {
        ...
        {
            MeshVertexDataDefinition& vertex0 = *(MeshVertexDataDefinition*)(vertex_data + (start_vertex_index + 0) * stride);
            vertex0.x = 0.0f;
            vertex0.y = 0.0f;
            vertex0.z = 0.0f;
            vertex0.u = 6.0f;
            ...
            MeshVertexDataDefinition& vertex1 = *(MeshVertexDataDefinition*)(vertex_data + (start_vertex_index + 1) * stride);
            vertex1.x = 0.1f;
            vertex1.y = 0.0f;
            vertex1.z = 0.0f;
            vertex1.u = 6.0f;
            ...
            MeshVertexDataDefinition& vertex2 = *(MeshVertexDataDefinition*)(vertex_data + (start_vertex_index + 2) * stride);
            vertex2.x = 0.1f;
            vertex2.y = 0.1f;
            vertex2.z = 0.0f;
            vertex2.u = 6.0f;
            ...
            MeshVertexDataDefinition& vertex3 = *(MeshVertexDataDefinition*)(vertex_data + (start_vertex_index + 3) * stride);
            vertex3.x = 0.0f;
            vertex3.y = 0.1f;
            vertex3.z = 0.0f;
            vertex3.u = 6.0f;
            ...
            MeshVertexDataDefinition& vertex4 = *(MeshVertexDataDefinition*)(vertex_data + (start_vertex_index + 4) * stride);
            vertex4.x = 0.0f;
            vertex4.y = 0.0f;
            vertex4.z = 0.1f;
            vertex4.u = 6.0f;
            ...
            MeshVertexDataDefinition& vertex5 = *(MeshVertexDataDefinition*)(vertex_data + (start_vertex_index + 5) * stride);
            vertex5.x = 0.1f;
            vertex5.y = 0.0f;
            vertex5.z = 0.1f;
            vertex5.u = 6.0f;
            ...
            MeshVertexDataDefinition& vertex6 = *(MeshVertexDataDefinition*)(vertex_data + (start_vertex_index + 6) * stride);
            vertex6.x = 0.1f;
            vertex6.y = 0.1f;
            vertex6.z = 0.1f;
            vertex6.u = 6.0f;
            ...
            MeshVertexDataDefinition& vertex7 = *(MeshVertexDataDefinition*)(vertex_data + (start_vertex_index + 7) * stride);
            vertex7.x = 0.0f;
            vertex7.y = 0.1f;
            vertex7.z = 0.1f;
            vertex7.u = 6.0f;
