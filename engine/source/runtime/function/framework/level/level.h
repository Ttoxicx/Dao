...
namespace Dao {
	...
	using LevelObjectMap = std::unordered_map<GObjectID, std::shared_ptr<GObject>>;
	...
	public:
		...
		const LevelObjectMap& getAllGObjects() const { return m_gobjects; }
