...
namespace Dao {
	...
	struct ParticleEmitterDesc {
		...
		ParticleEmitterDesc(
			const ParticleComponentRes& component_res,
			...
			m_size(component_res.m_size), m_emitter_type(component_res.m_emitter_type),
			m_life(component_res.m_life), m_color(component_res.m_color)
		{}
	};
}